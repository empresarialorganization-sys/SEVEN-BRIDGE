...
function createServer(env) {
  ...
  server.registerTool(
    "seven_command",
    {
      ...
      description:
        "Queue exactly one command for the paired SEVEN browser and return a commandId immediately. Never wait for browser completion inside this tool. Use seven_result separately.",
      inputSchema: z.object({
        code: z.string().regex(CODE_RE).describe("Permanent 6-digit SEVEN device code."),
